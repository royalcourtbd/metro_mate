...
import 'package:metro_mate/core/static/font_family.dart';

class MetroMateTheme {
  MetroMateTheme._();

  static ThemeData lightTheme = ThemeData(
    extensions: const [
      MetroMateThemeColor.light,
    ],
    fontFamily: FontFamily.generalSans,
    scaffoldBackgroundColor: MetroMateAppColor.scaffoldBachgroundColor,
    primaryColor: MetroMateAppColor.primaryColor,
    colorScheme: const ColorScheme.light(
      brightness: Brightness.light,
      primary: MetroMateAppColor.primaryColor,
      error: MetroMateAppColor.errorColor,
    ),
    useMaterial3: true,
    appBarTheme: const AppBarTheme(
      backgroundColor: MetroMateAppColor.scaffoldBachgroundColor,
    ...
    textTheme: const TextTheme(
      bodyMedium: TextStyle(
        color: MetroMateAppColor.titleColor,
        fontFamily: FontFamily.generalSans,
        height: 1.6,
      ),
      bodySmall: TextStyle(
