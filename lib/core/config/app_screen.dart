...
/// a factor that represents a quarter of the App screen width percentage. It is used
/// by the `px` method in the `DeviceExt` extension to convert numerical values to pixels.
/// The quarter percentage is calculated as the ratio between one-quarter of the App
