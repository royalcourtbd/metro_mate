...
import 'package:metro_mate/presentation/metro_mate.dart';
...
class MetroMateAppScreen {
  MetroMateAppScreen._();
  ...
  static Size get _size => MediaQuery.sizeOf(MetroMate.globalContext);
...
extension PrayerTimeAppScreenWidth on Widget {
  ...
  double get onePercentWidth {
    ...
    _onePercentWidth ??= MetroMateAppScreen.width * onePercent;
  ...
  double get twoPercentWidth {
    ...
    _twoPercentWidth ??= MetroMateAppScreen.width * twoPercent;
  ...
  double get fiftyPercentHeight {
    ...
    _fiftyPercentHeight ??= MetroMateAppScreen.height * fiftyPercent;
  ...
  double get threePercentWidth {
    ...
    _threePercentWidth ??= MetroMateAppScreen.width * threePercent;
  ...
  double get sixPercentWidth {
    ...
    _sixPercentWidth ??= MetroMateAppScreen.width * sixPercent;
  ...
  double get sevenPercentWidth {
    ...
    _sevenPercentWidth ??= MetroMateAppScreen.width * sevenPercent;
  ...
  double get eightPercentWidth {
    ...
    _eightPercentWidth ??= MetroMateAppScreen.width * eightPercent;
  ...
  double get tenPercentWidth {
    ...
    _tenPercentWidth ??= MetroMateAppScreen.width * tenPercentWidth;
  ...
  double get fortyPercentWidth {
    ...
    _fortyPercentWidth ??= MetroMateAppScreen.width * fortyPercent;
  ...
  double get thirtyPercentWidth {
    ...
    _thirtyPercentWidth ??= MetroMateAppScreen.width * thirtyPercentWidth;
  ...
  double get seventyPercentWidth {
    ...
    _seventyPercentWidth ??= MetroMateAppScreen.width * seventyPercent;
  ...
  double get tweentyEightPercentWidth {
    ...
    _tweentyEightPercentWidth ??=
        MetroMateAppScreen.width * tweentyEightPercentWidth;
  ...
  double get twentyPercentWidth {
    ...
    _twentyPercentWidth ??= MetroMateAppScreen.width * twentyPercentWidth;
  ...
  double get twentyFivePercentWidth {
    ...
    _twentyFivePercentWidth ??=
        MetroMateAppScreen.width * twentyFivePercentWidth;
  ...
  double get twentySixPercentWidth {
    ...
    _twentySixPercentWidth ??= MetroMateAppScreen.width * twentySixPercentWidth;
  ...
  double get twentyThreePercentWidth {
    ...
    _twentyThreePercentWidth ??=
        MetroMateAppScreen.width * twentyThreePercentWidth;
  ...
  double get fourtyPercentWidth {
    ...
    _fourtyPercentWidth ??= MetroMateAppScreen.width * fourtyPercentWidth;
  ...
  double get twentyPercentHeight {
    ...
    _twentyPercentHeight ??= MetroMateAppScreen.height * twentyPercent;
  ...
  double get tenPercentHeight {
    ...
    _tenPercentHeight ??= MetroMateAppScreen.height * tenPercentHeight;
  ...
  double get twelvePercentHeight {
    ...
    _twelvePercentHeight ??= MetroMateAppScreen.height * twentyPercent;
  ...
  double get fourteenPercentHeight {
    ...
    _fourteenPercentHeight ??=
        MetroMateAppScreen.height * fourteenPercentHeight;
  ...
  double get tweentyPercentHeight {
    ...
    _tweentyPercentHeight ??= MetroMateAppScreen.height * tweentyPercentHeight;
...
extension DeviceExt on num {
  ...
  double get percentHeight {
    _heightPercent ??= MetroMateAppScreen.height / 100;
  ...
  double get percentWidth {
    _widthPercent ??= MetroMateAppScreen.width / 100;
...
double _calculatePrayerTimeAppScreenWidthQuarterPercentage() {
  return (MetroMateAppScreen.width / 3.9) / 100;
}
