...
import 'package:metro_mate/core/config/metro_mate_theme_color.dart';
import 'package:metro_mate/core/external_libs/flutter_toast/toast_utility.dart';
import 'package:metro_mate/core/external_libs/throttle_service.dart';
import 'package:metro_mate/core/static/constants.dart';
...
Future<void> showMessage({
  ...
  ToastUtility.showCustomToast(
    context: context ?? MetroMate.globalContext,
    message: message,
    yOffset: 100.0,
...
extension ThemeContextExtension on BuildContext {
  MetroMateThemeColor get color {
    return Theme.of(this).extension<MetroMateThemeColor>()!;
  }
}
